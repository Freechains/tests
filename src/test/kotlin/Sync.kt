...
class Tests_Sync {
    ...
    @Test
    fun s01 () { // TODO: this test sometimes fail, why?
        ...
        thread { main_sync(arrayOf(port(11), "@$PUB0", pair(10))) }
    ...
    fun t00 () {
        ...
        val sync = Sync(store, pair(0), CBS)
        thread { sync.loop() }
        Thread.sleep(500)
        assert (
    ...
    fun t01 () {
        ...
        thread { main_sync(arrayOf(port(3), "\$sync.xxx", pair(2))) }
        Thread.sleep(200)
